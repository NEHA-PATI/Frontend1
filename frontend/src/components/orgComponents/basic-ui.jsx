...
export const DialogTrigger = ({ asChild, children, open, setOpen, ...props }) => {
...
export const DialogContent = ({ className = "", children, open, setOpen, ...props }) => {
  if (!open) return null;

  const handleBackdropClick = (e) => {
    if (e.target === e.currentTarget) setOpen && setOpen(false);
  };
