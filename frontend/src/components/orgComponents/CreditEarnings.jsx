...
//   const assetTypeData = [
//     { name: "Solar", value: 892, color: "var(--color-yellow)" },
//     { name: "Wind", value: 1534, color: "var(--color-cyan)" },
//     { name: "Trees", value: 678, color: "var(--color-green)" },
//     { name: "EV", value: 245, color: "var(--color-blue)" },
//     { name: "Hydro", value: 423, color: "var(--color-purple)" },
//     { name: "Carbon Capture", value: 1247, color: "var(--color-gray)" },
//   ];
...
//         <div>
//           <h1 className="text-3xl font-bold">Credit Earnings & Analytics</h1>
...
//       {/* Summary Cards */}
//       <div className="grid-1 md-grid-4">
//         <Card>
//           <CardContent>
//             <div className="flex items-center justify-between">
//               <div>
...
//         </CardHeader>
//         <CardContent>
//           <div className="grid-1 md-grid-3">
//             <motion.div
...
//               <div className="text-xs text-secondary mt-2">vs. Current Quarter</div>
//             </motion.div>
//           </div>
//         </CardContent>
//       </Card>
